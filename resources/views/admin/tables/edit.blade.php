                 ...
                 <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                       <form action="{{ route('admin.tables.update', $table->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="sm:col-span-6 pt-5 mt-3">
                               ...
                               <div class="mt-1">
                                  <input type="text" name="name" id="name" value="{{ $table->name }}" class="block w-full transition">
                               </div>                           
                            </div>
                            ...
                            <div class="sm:col-span-6 pt-5 mt-3">
                               ...
                               <div class="mt-1">
                                  <input type="number" name="guest_number" id="guest_number" value="{{ $table->guest_number }}" class="block w-full transition">
                               </div>                           
                            </div>
